...
function cloudProjectPayload(project) {
  return {
    ...
    versionHistory: Array.isArray(project.versionHistory) ? project.versionHistory.slice(-20) : [],
    cloudSyncState: text(project.cloudSyncState, 32) || "synced",
    cloudSavedAt: text(project.cloudSavedAt, 48),
...
export function cloudProjectToLocal(project) {
  ...
  return {
    ...
    versionHistory: Array.isArray(project.versionHistory) ? project.versionHistory.slice(-20) : [],
    cloudSyncState: project.cloudSyncState || "synced",
