...
const VIEW_GROUPS = {
  ...
  "instrument-lab": ["instrument-lab", "mixer-panel"],
  "beat-maker": ["beat-maker", "timeline", "mixer-panel"],
  "my-sounds": ["my-sounds", "timeline", "mixer-panel"],
  "producer-studio": ["producer-studio"],
  timeline: ["timeline", "mixer-panel", "instrument-lab", "sound-library"],
  "mixer-panel": ["timeline", "mixer-panel", "instrument-lab", "sound-library"],
